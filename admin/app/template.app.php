...
class TemplateApp extends BackendApp {
    ...
    function get_editor_panel() {
        ...
        foreach ($widgets as $key => $widget) {
            if (!empty($widget['theme']) && $widget['theme'] != Conf::get('template_name')) {
                unset($widgets[$key]);
            }
        }
...
//            'groupbuy' => $real_site_url . '/index.php?app=search&act=groupbuy',
            ...
            'channel_bendichanpin' => $real_site_url . '/index.php?app=channel_bendichanpin',
            'channel_bendifuwu' => $real_site_url . '/index.php?app=channel_bendifuwu',
            'channel_bendishichang' => $real_site_url . '/index.php?app=channel_bendishichang',
//            'integral' => $real_site_url . '/index.php?app=integral',
//            'ju' => $real_site_url . '/index.php?app=ju',
//            'ju_brand' => $real_site_url . '/index.php?app=ju_brand',
//            'ju_mingpin' => $real_site_url . '/index.php?app=ju_mingpin',
//            'ju_decoration' => $real_site_url . '/index.php?app=ju_decoration',
//            'ju_life' => $real_site_url . '/index.php?app=ju_life',
//            'ju_travel' => $real_site_url . '/index.php?app=ju_travel',
//            'channel_appliances' => $real_site_url . '/index.php?app=channel_appliances',
//            'channel_phone' => $real_site_url . '/index.php?app=channel_phone',
//            'channel_clothing' => $real_site_url . '/index.php?app=channel_clothing',
            'article' => $real_site_url . '/index.php?app=article',
//            'channel_shop' => $real_site_url . '/index.php?app=channel_shop',
        );
    }
