...
class ChuanglanSmsApi {
    ...
    var $api_send_url = 'http://222.73.117.156/msg/HttpBatchSendSM';

    //创蓝短信余额查询接口URL, 如无必要，该参数可不用修改
    var $api_balance_query_url = 'http://222.73.117.156/msg/QueryBalance';

    //创蓝账号 替换成你自己的账号
    var $api_account;// = 'hzkj88_zhying';

    //创蓝密码 替换成你自己的密码
    var $api_password;//	= 'zhying@123';

    function __construct(){
        $this->api_account = Conf::get('msg_pid');
        $this->api_password = Conf::get('msg_key');
    }
	/**
	 * 发送短信
	 *
