...
CREATE TABLE `ecm_fanli_setting` (
  ...
  `chouchenguse_fanli_ratio` float(10,2) NOT NULL DEFAULT '0.0' COMMENT '平台的总抽成用于返利的比例(精准度0.1)',
  ...
  `jinbi2rmb` int(9) NOT NULL DEFAULT '1' COMMENT '金币到人民币转换率(默认1)',
...
--
-- 表的结构 `ecm_fanli_jinbi`
--
DROP TABLE `ecm_fanli_jinbi`;
CREATE TABLE `ecm_fanli_jinbi` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
